Public Class BdgLibroEmbotellados
    ...
    Private Const cnEntidad As String = "tbBdgLibroEmbotellados"
...
#End Region
    ...
    <Task()> Public Shared Sub Declarar(ByVal data As DatosEntradasSalidas, ByVal services As ServiceProvider)
        ...
        Dim dtLibro As DataTable = New BdgLibroEmbotellados().Filter(f)
...
Public Enum enumBdgTipoMovimientoLibroEmbotellados
    Manual = 0
    EntradaUva = 1
    CompraVino = 2
    SalidaUva = 3
