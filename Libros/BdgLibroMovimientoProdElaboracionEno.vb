Public Class BdgLibroMovimientoProdElaboracionEno
    ...
    Private Const cnEntidad As String = "tbBdgLibroMovimientoProdElaboracionEno"
...
#End Region
    ...
    <Task()> Public Shared Sub Declarar(ByVal data As DatosEntradasSalidas, ByVal services As ServiceProvider)
        ...
        Dim dtLibro As DataTable = New BdgLibroMovimientoProdElaboracionEno().Filter(f)
        If dtLibro.Rows.Count > 0 Then
            For Each drLibro As DataRow In dtLibro.Rows
                drLibro("Declarado") = True
            Next
            BdgLibroMovimientoProdElaboracionEno.UpdateTable(dtLibro)
        End If
    End Sub
